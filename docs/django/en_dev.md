...
![Support Django!](https://static.djangoproject.com/img/fundraising-heart.cd6bb84ffd33.svg)
  * SimplyMaid Sydney donated to the Django Software Foundation to support Django development. Donate today! 
...
## Download:
Offline (development version): HTML | PDF | ePub Provided by Read the Docs. 
# Django Links
## Learn More
  * About Django
