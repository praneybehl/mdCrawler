...
```
importopenai
fromsimulation_utilsimport langchain_to_openai_messages

openai_client = openai.Client()


defassistant(messages: list) -> str:
...
fromsimulation_utilsimport create_simulated_user
...
```
fromsimulation_utilsimport create_chat_simulator
...
```
fromlangchain.smithimport RunEvalConfig
...
classRedTeamingResult(BaseModel):
